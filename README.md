...
def book_rec(user_id):
 ...
 ## Additional
 An extension of this project that provides aspect-based and topic modeling-based sentiment analysis for the user reviews of a book that was completed in my second practicum course can be found at [this repository](https://github.com/DarrellS0352/msds696_x70_data_science_practicum_2/blob/main/README.md)
