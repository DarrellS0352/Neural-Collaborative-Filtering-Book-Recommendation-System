...
def book_rec(user_id):
 ...
 ## Additional
 An extension of this project that provides aspect-based and topic modeling-based sentiment analysis for the user reviews of a book that was completed in my second practicum course can be found at [this repository](https://github.com/DarrellS0352/Combined-Guided-Topic-Modeling-Based-and-Aspect-Based-Sentiment-Analysis-For-Book-User-Reviews)
